...
index = do
	...
	textLeftImg "images/home/IMG_1376.JPG" "Passion for Humanities and Sciences" "Among our team we have graduated from Yale, Columbia, and Harvard, with masters degrees and PhDs in disciplines ranging from Computer Science and Medicine, to Acting and Theology. We are from Korea, Germany, Brooklyn, and Massachusetts. We work at Amazon, Microsoft, on Broadway, and in coffee shops. "
	textRightImg "images/home/students_at_board.jpg" "Experienced and Enthusiastic" "Gyoshil dedicates 10% of our classroom to scholarship students. Please let us know when you apply if you have any financial constraints and we promise you we will try to meet them. We offer free lunch to scholarship students as well."
